...
class Zone(models.Model):
    ...
    insulationlength = models.ForeignKey(Material, models.DO_NOTHING, db_column='insulationLength', related_name='zone_insulationlen>    directionelectrically = models.CharField(db_column='directionElectrically', max_length=100)  # Field name made lowercase.
