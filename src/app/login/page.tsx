        ...
        <div className="flex items-center justify-center min-h-screen">
            <div className=" w-80 h-100 mx-auto p-5 rounded-lg shadow-lg text-center">
                ...
                <form className="flex flex-col">
                    ...
                    <input type="email" className="rounded-lg  p-2 mb-3 rounded border border-gray-300 text-base" required />
                    <label className="text-left font-thin mb-1 text-neutral-500 text-sm">Password</label>
                    <input type="password" className="rounded-lg p-2 mb-3  border border-gray-300 text-base" required />
