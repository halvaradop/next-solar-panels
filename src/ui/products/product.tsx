...
export const Product = ({ className, title, subtitle, description, src, alt, isRight }: ProductProps) => {
    const figureVariant = isRight ? "base:grid-cols-[0.35fr_0.65fr]" : "base:grid-cols-[0.65fr_0.35fr]"
    return (
        <article className={merge("flex flex-col gap-y-4", className, { "text-right": isRight, "items-end": isRight })}>
