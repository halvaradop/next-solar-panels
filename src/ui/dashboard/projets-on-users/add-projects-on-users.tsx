...
export const AddProjectOnUser = () => {
    ...
    useEffect(() => {
        const getData = async () => {
            ...
            const [conctacPerson, projects] = await Promise.all([
                getContactPersonByStakeHolderId(stakeHolderId),
                getProjectsByStakeHolderId(stakeHolderId),
            ])
    ...
    return (
        <Form className="w-full min-h-main pt-4" action={formAction}>
            ...
            <Label className="w-full text-neutral-700" size="sm">
                Plant
                <SelectGeneric values={projects} id="designation" value="idProject" name="plant" />
            </Label>
